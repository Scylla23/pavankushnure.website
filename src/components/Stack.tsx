...
const skills = [
  ...
  "Redux", "Recoil", "Micro-frontends", "Tailwind CSS",
  "MongoDB", "PostgreSQL", "Redis", "Algolia",
  "Qdrant", "Pinecone", "Weaviate",
  "RAG", "Agentic workflows", "MCP", "Embeddings", "Hybrid search", "Reranking",
  "LLM guardrails & evaluation", "LangChain", "LlamaIndex", "LangGraph",
  "AWS", "GCP", "OCI", "Docker", "Kubernetes", "Terraform", "CI/CD", "Nginx",
  "Stripe API", "OAuth 2.0"
];
